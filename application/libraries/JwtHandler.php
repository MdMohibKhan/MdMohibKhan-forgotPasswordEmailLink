...
require 'jwtToken/JWT.php';
require 'jwtToken/ExpiredException.php';
require 'jwtToken/SignatureInvalidException.php';
require 'jwtToken/BeforeValidException.php';
...
class JwtHandler {
    ...
    public function __construct()
    {
        ...
        // $this->expire = $this->issuedAt + 1800; // 1/2 hr
